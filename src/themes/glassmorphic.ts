...
export const glassmorphicTheme: Theme = {
  ...
  customClasses: {
    ...
    successButton: 'bg-green-500/50 hover:bg-green-500/70 backdrop-blur-md border border-white/30 shadow-lg hover:scale-105 transition-all text-white',
    dangerButton: 'bg-red-500/50 hover:bg-red-500/70 backdrop-blur-md border border-white/30 shadow-lg hover:scale-105 transition-all text-white',
    warningButton: 'bg-yellow-500/50 hover:bg-yellow-500/70 backdrop-blur-md border border-white/30 shadow-lg hover:scale-105 transition-all text-white',
    infoButton: 'bg-blue-500/50 hover:bg-blue-500/70 backdrop-blur-md border border-white/30 shadow-lg hover:scale-105 transition-all text-white',
